                 ...
                 {event.speakers && event.speakers.length > 0 && (
                   <div className="flex -space-x-1.5 overflow-hidden">
                     {event.speakers.map((s, i) => (
                       <div key={i} className="inline-block h-6 w-6 rounded-full ring-2 ring-white overflow-hidden bg-slate-100 border border-slate-200" title={s.name}>
                         {s.photoUrl ? (
                           <img 
                             src={s.photoUrl} 
                             alt={s.name} 
                             ...
                             onError={(e) => {
                               ...
                               if (parent) {
                                  ...
                                  span.className = "h-full w-full flex items-center justify-center text-[8px] font-black text-slate-400";
                                  span.innerText = s.name.charAt(0);
